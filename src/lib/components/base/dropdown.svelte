...
{#if open}
	...
	<div class="fixed top-0 right-0 bottom-0 left-0 z-[999999999] bg-gray-50/0 dark:bg-gray-800/0">
		...
		<div
			...
			class={twMerge(
				'fixed h-fit max-h-[calc(100vh-2rem)] rounded border border-gray-300 bg-gray-50 dark:border-gray-600 dark:bg-gray-800',
				'pointer-events-auto overflow-auto p-1 text-gray-900 dark:text-gray-200',
				className
			)}
		>
			{@render children?.()}
